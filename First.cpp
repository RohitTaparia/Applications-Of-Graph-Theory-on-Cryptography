// Algorithm has been implemented in C++ language

//------------------------------------------------------------

// This algorithm takes a string as input.
// This input string is then passed to Encoder Class which encodes the entire string according to the algorithm
...
// The Decode class takes the cipher text from encoder class and decodes it.
...
int main()
{
    ...
    cout<<"\nM1: Adjacency Matrix of the complete graph generated by taking characters in message as nodes\nM2: Minimum spanning tree formed by using th graph M1\nM3: Matrix obtained by multiplication of M1 and M2\nKey: It is a pre-defined shared key\nCipher: Matrix obtained by multiplying marices M3 and key\n\n";

    // Creating object of class Encoder and taking the message as input
    Encoder ob1;
    // Encoding message
    ob1.superiorFunc();
